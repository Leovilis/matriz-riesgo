...
import { Lock, Shield, AlertCircle, CheckCircle, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-700 to-blue-800 px-6 py-6 text-center">
          ...
          <p className="text-blue-100 text-sm mt-1">
            {session?.user?.area} - {session?.user?.email}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
